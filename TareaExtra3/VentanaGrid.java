...
public class VentanaGrid extends Frame{
    ...
    public VentanaGrid(String title) throws HeadlessException {
        super(title);
        layout = new GridLayout(3,2); //El tamano


        lblEtiqueta1 = new Label("Etiqueta 1");
        this.add(lblEtiqueta1, 0);  //Se lo estamos agregando a la pocision 0
        ...
        boton1.addMouseListener(new MouseAdapter() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                JOptionPane.showMessageDialog(null,texto);  //Para montarlo a un ventanita
            }
        });
        ...
        this.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                System.exit(0); //Todo se ejecuto bien
            }
        });
